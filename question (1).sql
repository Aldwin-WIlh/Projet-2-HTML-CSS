...
INSERT INTO rep (id, idquest,idfeed, rep, resultat) VALUES
(1, 1,1, 'Masahiro Sakurai', TRUE),
(2, 2,2, '1999', TRUE),
(3, 3,3, 'Pikachu', TRUE),
(4, 4,4, 'Waluigi', TRUE),
(5, 5,5, '82', TRUE),
(6, 6,6, 'EVO', TRUE),
(7, 7,7, 'Donkey Kong', TRUE),
(8, 8,8, 'Mewtwo', TRUE),
(9, 9,9, 'King K Rool', TRUE),
(10, 10,10,'Zelda et Sheik', TRUE),
(11, 11,11,'Captain Falcon', TRUE),
(12, 12,12,'Ness', TRUE),
(13, 1,1,'Marc Merril', FALSE),
(14, 1,1,'Shigeru Miyamoto', FALSE),
(15, 1,1,'Yu Suzuki', FALSE),
(16, 2,2,'2008', FALSE),
(17, 2,2,'2001', FALSE),
(18, 2,2,'1996', FALSE),
(19, 3,3,'sonic', FALSE),
...
(26,5,5, '53',FALSE),
(27,5,5, '56',FALSE),
(28,6,6, 'le Pound',FALSE),
(29,6,6, 'genesis',FALSE),
(30 ,6,6 ,'smash summit' ,FALSE ),
(31 ,7,7 ,'luigi' ,FALSE ),
(32 ,7 ,7,'roi dadidou' ,FALSE ),
(33 ,7 ,7,'peach' ,FALSE ),
(34 ,8 ,8,'pikachu' ,FALSE ),
(35 ,8 ,8,'kyurem' ,FALSE ),
(36 ,8 ,8,'amphinobi' ,FALSE ),
(37 ,9 ,9,'falco' ,FALSE ),
(38 ,9 ,9,'corin' ,FALSE ),
(39 ,9 ,9,'ganondorf' ,FALSE ),
(40 ,10 ,10,'peach et daisy' ,FALSE ),
(41 ,10 ,10,'link et link enfant' ,FALSE ),
(42 ,10 ,10,'mario et luigi' ,FALSE ),
(43 ,11 ,11,'mario' ,FALSE ),
(44 ,11 ,11,'samus' ,FALSE ),
(45 ,11 ,11,'chrom' ,FALSE ),
(46 ,12 ,12,'lucas' ,FALSE ),
(47 ,12 ,12,'bowser' ,FALSE ),
(48 ,12 ,12,'felinferno' ,FALSE );
